...
if choice == 1:
    ...
    sqlFormula = (
        "INSERT INTO User_Info(userID, NAME, Date_of_Birth) VALUES (%s, %s, %s)"
    )
    ...
    sqlFormula = (
        "INSERT INTO Task(task_id, user_ID, Task, Deadline) VALUES (%s, %s, %s, %s)"
    )
    ...
    if choiceUpdate == 1:
        ...
        deadline_new = input("Enter your Deadline (new): ")
        sqlFormula = (
            "UPDATE Task SET DEADLINE = %s WHERE task_id = %s AND DEADLINE = %s"
        )
